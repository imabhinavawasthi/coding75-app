...
const BookBlurMeeting = ({ type = "1:1 coding75 Meeting", meeting_time = "45", meeting_frequency = "1" }: any) => {
    return (
            ...
            <Alert className="mb-5">
                ...
                <AlertDescription>
                    <p className="flex items-center">
                        <Dot className="mr-2" />
                        You can book a &nbsp; <strong>{type}</strong> &nbsp; session in every&nbsp; <strong>{meeting_frequency}{meeting_frequency == 1 ? " month" : " months"}</strong> .
                    </p>
                    <p className="flex items-center">
                        <Dot className="mr-2" />
...
export default BookBlurMeeting;