            ...
            {features.map((feature, index) => (
              <motion.button
                ...
                onClick={() => {
                  ...
                  setProgress(0) // reset autoplay progress
                }}
                className="flex items-center gap-6 md:gap-8 w-full text-left cursor-pointer group"
                initial={{ opacity: 0.3 }}
                ...
                <motion.div
                  className={cn(
                    ...
                    index === currentFeature
                      ...
                      : "bg-muted border-muted-foreground group-hover:scale-105"
                  )}
                >
                  {index <= currentFeature ? (
