import { CandlestickChart, Code, Code2, Rocket, ScrollText, UserCheck } from "lucide-react";
            ...
            <section className="container">
                <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                    <div className="mb-8 lg:mb-16">
                        ...
                        <p className="text-center text-gray-500 sm:text-xl dark:text-gray-400">Here at Coding75, we prioritize the development of students in the dynamic world of coding and fast growing industry, making it your one-stop destination for a well-rounded coding education</p>
                    </div>
