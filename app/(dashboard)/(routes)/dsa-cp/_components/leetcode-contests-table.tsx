...
export default function LeetcodeContestsProblemTable({ data }) {
                    ...
                    <div className="flex items-center">
                        ...
                        <div className="overflow-clip w-48 text-left">
                            <TooltipProvider delayDuration={0}>
                                <Link href={"/dsa-cp/leetcode-contests/" + problem.SlugUrl}>
                                    <Tooltip>
                ...
                return (
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                            ...
                            <DropdownMenuSeparator />
                            <DropdownMenuItem><Link href={"/dsa-cp/leetcode-contest/" + problem.SlugUrl}>View Problem</Link></DropdownMenuItem>
                        </DropdownMenuContent>
                    </DropdownMenu>
                )
            },
    ...
    return (
        <div className="w-full">
            <div className="flex items-center py-4 gap-x-5">
                ...
                <div className="flex flex-col">
                    <Label htmlFor="difficultyfilter" className="mb-2">Filter Difficulty</Label>
                    <Select
                        value={(table.getColumn("Difficulty")?.getFilterValue() as string) ?? ""}
                        onValueChange={(event) => {
                            if (event == "All") {
                                table.getColumn("Difficulty")?.setFilterValue("")
                            }
                            else {
                                table.getColumn("Difficulty")?.setFilterValue(event)
                            }
                        }
                        }
                    >
                        <SelectTrigger className="w-36" id="difficultyfilter">
                            <SelectValue placeholder="All" />
                        </SelectTrigger>
                        <SelectContent>
                            <SelectGroup>
