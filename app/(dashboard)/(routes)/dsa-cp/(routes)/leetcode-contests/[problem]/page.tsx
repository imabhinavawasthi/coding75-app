...
import { BookText, BriefcaseIcon, Calendar, Check, ExternalLink, FileCode2, FileVideo, Gauge, GraduationCap, Share2 } from "lucide-react";
                            ...
                            <div className="lg:container md:container px-3">
                                ...
                                <Breadcrumb>
                                        <BreadcrumbList>
                                            ...
                                            <BreadcrumbSeparator />
                                            <BreadcrumbItem>
                                                <BreadcrumbLink href="/dsa-cp/leetcode-contests">Leetcode Contests</BreadcrumbLink>
                                            </BreadcrumbItem>
                                        </BreadcrumbList>
                                    </Breadcrumb>
                                </div>
                                        ...
                                        <div className="min-w-0 flex-1">
                                            ...
                                            <div className="mt-1 flex flex-col sm:mt-0 sm:flex-row sm:flex-wrap sm:space-x-6">
                                                <div className="mt-4 flex items-center text-sm text-gray-500">
                                                    <GraduationCap className="mr-1.5 h-5 w-5 flex-shrink-0 text-gray-400" aria-hidden="true" />
