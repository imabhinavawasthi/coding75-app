...
export function ContestProblemDetailClient({
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-5xl mx-auto space-y-6">
      ...
      <div className="rounded-2xl border border-border/70 bg-gradient-to-br from-card via-card/95 to-muted/20 p-5 sm:p-7 shadow-xs space-y-4">
        ...
        <div className="space-y-2.5 w-full">
          ...
          <h1 className="text-2xl sm:text-3xl font-extrabold text-foreground tracking-tight leading-snug w-full">
            {problem.problem_name}
          </h1>
        ...
        <div className="flex items-center justify-between gap-3 flex-wrap pt-3 border-t border-border/60">
          <div className="flex items-center gap-2 flex-wrap">
            {/* Status Dropdown */}
            {isLoadingStates ? (
              <div className="flex items-center gap-1.5 h-8.5 px-3 text-xs font-medium rounded-md bg-muted/40 text-muted-foreground border border-border/50 animate-pulse">
            ...
            {hasSolutions && (
              <Button
                ...
                className="h-8.5 px-3 text-xs font-semibold gap-1.5 bg-primary/10 text-primary border-primary/30 hover:bg-primary/20 hover:text-primary transition-all cursor-pointer"
              >
            ...
            <Button
              ...
              size="sm"
              onClick={handleShare}
              className="h-8.5 px-3 text-xs font-semibold gap-1.5 bg-background hover:bg-muted"
            >
          ...
          {problem.problem_link && (
            <Button asChild size="sm" className="h-8.5 px-4 text-xs font-bold gap-1.5 bg-primary text-primary-foreground shadow-xs">
