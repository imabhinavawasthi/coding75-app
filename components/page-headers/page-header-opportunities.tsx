                ...
                <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
                    <div className="sm:flex sm:items-center sm:justify-between">
                        <div className="mr-auto place-self-center lg:col-span-7">
                            <h2 className="mb-10 text-4xl font-extrabold tracking-tight leading-none dark:text-white">
                                <Typewriter
                                    options={{
                                        strings: [
                                ...
                                /></h2>
                            <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 dark:text-gray-400">Stay ahead in your coding career by exploring the vast array of opportunities presented by Coding75 and propel yourself into the forefront of the tech industry.</p>
                            <div className="md:flex md:flex-row items-center">
                                ...
                                <div className='w-full mt-3 md:mt-0 hover:animate-background rounded-xl bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 p-0.5 shadow-xl transition hover:bg-[length:400%_400%] hover:shadow-sm hover:[animation-duration:_4s]'>
